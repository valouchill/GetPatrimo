/**
 * Templates de relance pour les loyers impayés — SOURCE UNIQUE.
 *
 * En CommonJS car consommé À LA FOIS par le cron Node pur
 * (src/cron/monthlyPayments.js) et par la route Next
 * (app/api/payments/remind/route.ts via la façade lib/templates/rent-reminders.ts).
 * Les deux politiques de relance divergeaient auparavant (seuils et niveaux).
...
Cordialement,
Votre bailleur — via Maison Patrimo`,
  },
...
Maison Patrimo — Alerte automatique`,
  },
};
 ...
 */
function fillReminderTemplate(type, vars) {
...
module.exports = { REMINDER_TEMPLATES, fillReminderTemplate };
