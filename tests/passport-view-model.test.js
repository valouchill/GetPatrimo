...
test('Passport becomes ready when the dossier is complete and stable', () => {
  ...
  assert.equal(passport.previewUrl, 'https://maisonpatrimo.com/p/alice-martin-demo?preview=1');
  assert.equal(passport.shareUrl, 'https://maisonpatrimo.com/p/alice-martin-demo');
});
