        ...
        <div className="rounded-[1.9rem] border border-white/80 bg-white/82 p-5 shadow-[0_30px_80px_-48px_rgba(15,23,42,0.45)] backdrop-blur">
          {focusCard ? (
            <div className="space-y-5">
              ...
              <Link
                href={focusCard.ctaHref}
                className="inline-flex w-full items-center justify-center gap-2 rounded-[1.35rem] bg-amber-500 px-4 py-3.5 text-sm font-semibold text-white transition hover:bg-amber-600"
              >
                {focusCard.ctaLabel}
                <ArrowRight className="h-4 w-4" />
              </Link>
