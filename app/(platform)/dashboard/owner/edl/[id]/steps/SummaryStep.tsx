      ...
      <div className="flex flex-col items-center justify-center gap-6 py-12 text-center">
        ...
        {inspection.pdfUrl && (
          <a
            ...
            className="flex items-center gap-2 rounded-2xl bg-orange-500 px-6 py-3 text-sm font-bold text-white shadow-md hover:bg-orange-600"
          >
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-2xl bg-orange-500 py-4 text-sm font-bold text-white shadow-md transition-colors hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed"
        >
