          ...
          {property.applyToken && !property.isRented && (
            <PremiumSurface padding="md" className="rounded-3xl border-amber-100 bg-amber-50/40">
              ...
              <p className="mb-4 text-sm leading-6 text-slate-600">
                Partagez ce lien unique pour permettre aux candidats de déposer leur dossier directement sur ce bien. Chaque candidature est analysée automatiquement par l&apos;IA Maison Patrimo.
              </p>
