        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 text-lg max-w-lg mx-auto">
              <strong>{guarantorInfo?.tenantName}</strong> a besoin de votre garantie pour sécuriser sa candidature Maison Patrimo.
            </p>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-amber-800 font-medium mb-2">
                      🧠 Conseil de l&apos;Expert Maison Patrimo
                    </p>
            ...
            {verificationMode === 'choice' && !diditVerificationUrl && (
              ...
              >
                ...
                <div className="grid gap-6">
                  ...
                  {/* Option Audit Maison Patrimo (Fallback) */}
                  <button
                  ...
                  >
                    <div className="flex min-w-0 flex-col items-start gap-5 sm:flex-row sm:gap-6">
                      ...
                      <div className="min-w-0 flex-1">
                        <h3 className="text-xl font-bold text-slate-800 mb-2">Audit Documentaire Maison Patrimo</h3>
            ...
            {verificationMode === 'audit' && (
              ...
              >
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-slate-800">Audit Documentaire Maison Patrimo</h2>
                ...
                {!auditResult && (
                  <>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-3 px-8 py-4 bg-amber-500 text-white rounded-xl text-sm font-bold hover:bg-amber-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {auditStatus === 'processing' ? (
                        ...
                        <>
                          ...
                          <span>Lancer l&apos;Audit Maison Patrimo</span>
                        </>
                      )}
                    </button>
                  </>
