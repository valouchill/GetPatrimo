...
/**
 * Page d'accueil Maison Patrimo (/) — Landing Page officielle V1.
 *
...
export const metadata: Metadata = {
  title: 'Maison Patrimo — Audit anti-fraude des dossiers locataires par IA',
  description:
  ...
  twitter: {
    ...
    title: 'Maison Patrimo — La nouvelle norme de sélection locative',
    description:
