...
export const POST = withAdmin(async (req: NextRequest, ctx: any, admin) => {
  ...
  await sendEmail({
    ...
    html: `<div style="font-family:Arial,sans-serif;max-width:600px;"><p>Bonjour${tenantName ? ' ' + tenantName : ''},</p><p>Veuillez trouver ci-joint votre quittance pour <strong>${periodLabel}</strong>.</p><p style="color:#64748B;font-size:13px;">Maison Patrimo</p></div>`,
