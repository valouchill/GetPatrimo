...
export async function sharePassportByEmail(
  ...
  try {
    ...
    // Construire l'URL
    const baseUrl = process.env.NEXT_PUBLIC_APP_URL || process.env.NEXTAUTH_URL || 'https://maisonpatrimo.com';
...
<head>
  ...
  <title>Dossier de candidature certifié - Maison Patrimo</title>
</head>
          ...
          <tr>
            <td style="padding: 50px 40px 30px;">
              ...
              <p style="margin: 0 0 30px; color: #334155; font-size: 15px; line-height: 1.7;">
                Pour vous faire gagner un temps précieux et sécuriser votre mise en location, ce candidat a fait <strong>auditer son dossier par Maison Patrimo</strong>, le standard de confiance immobilier.
              </p>
          ...
          <tr>
            <td style="padding: 0 20px; text-align: center;">
              <p style="margin: 0; color: #94A3B8; font-size: 11px; line-height: 1.6;">
                Cet email vous a été envoyé par ${data.tenantName} via Maison Patrimo.<br>
...
Pour vous faire gagner un temps précieux et sécuriser votre mise en location, ce candidat a fait auditer son dossier par Maison Patrimo, le standard de confiance immobilier.
...
<head>
  <meta charset="utf-8">
  <title>Votre Passeport a été consulté - Maison Patrimo</title>
</head>
          ...
          <tr>
            <td style="padding: 40px; text-align: center;">
              ...
              <p style="margin: 0; color: #64748B; font-size: 12px;">
                Maison Patrimo — Votre succès locatif, notre mission
              </p>
            </td>
          </tr>
        </table>
