...
interface SolvencyAnalysisProps {
  totalCertifiedIncome: number; // Revenu mensuel total certifié du Passeport Maison Patrimo
    ...
    >
      ...
      <div className="bg-gradient-to-r from-navy/5 to-emerald-50/50 border border-navy/10 rounded-xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h5 className="text-xs font-bold text-navy mb-1">Conseil Expert Maison Patrimo</h5>
