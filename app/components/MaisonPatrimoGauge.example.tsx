...
import MaisonPatrimoGauge from "./MaisonPatrimoGauge";

/**
 * Exemple d'utilisation du composant MaisonPatrimoGauge
 */
export default function MaisonPatrimoGaugeExample() {
  return (
    <div className="min-h-screen bg-slate-50 p-8 flex flex-col items-center justify-center gap-12">
      ...
      <div className="flex flex-col items-center gap-4 mt-8">
        ...
        <MaisonPatrimoGauge score={85} isLoading={true} />
      </div>
    </div>
  );
}
