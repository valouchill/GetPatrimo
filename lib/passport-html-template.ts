...
export function buildPassportHtml({
  ...
  // Marketing
  const signupUrl = escapeHtml(ownerSignupUrl || data.marketing?.ownerSignupUrl || 'https://maisonpatrimo.com/auth/register?role=owner');
...
<head>
    ...
    <style>
        @page {
            ...
            @bottom-left {
                content: "Maison Patrimo © 2026 • Document de Synthèse Confidentiel et Infalsifiable";
                font-family: 'Helvetica Neue', Arial, sans-serif;
                font-size: 8pt;
                color: #64748b;
            }
...
<body>
    ...
    <div class="header">
        <table class="w-full">
            <tr>
                <td>
                    <div class="brand-name">Maison Patrimo</div>
